...
보안 작업의 정책·요약 SSoT는 이 챕터(`05_security.md`)이며, 외부 공개용 위협·취약점 보고 절차는 [`SECURITY.md`](../../../SECURITY.md)에 정리되어 있다. (구 `docs/security_audit_worklog.md`는 DOC-S3에서 제거됨; 항목별 상태는 아래 인라인으로 유지.)
