...
- [2026-01-26] `apply_profile` 누락/오류 프로필 에러 처리 + 단위 테스트 추가.
- 근거: `.sisyphus/notepads/p0-settings/worklog.md`
...
- [2026-01-27] CI regression gate runner/워크플로 통합, PR 코멘트 포맷터 및 테스트 보강.
- 근거: `.sisyphus/notepads/p7-regression/worklog.md`
...
- [2026-01-27] 멀티턴 스키마/메트릭/CLI 로더 추가.
- [2026-01-27] 멀티턴 DB 스키마/저장/내보내기/Excel 스펙 및 저장 테스트 추가.
- 근거: `.sisyphus/notepads/p2-observability/worklog.md`
