...
- CLI 가이드에 retriever 옵션 추가 (`docs/CLI_GUIDE.md`)
- 개발 가이드에 StageEvent 규칙 및 retriever 자동 생성 규칙 추가 (`docs/internal/DEVELOPMENT_GUIDE.md`)
...
- StageEvent retrieval 메타데이터 계약 문서화 완료 (`docs/internal/DEBUG_TOOL_PLAN.md`)
