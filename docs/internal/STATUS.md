...
- 문서 통합/최신화 계획은 `docs/internal/DOCS_REFACTOR_PLAN.md`에 기록합니다.
...
참고 문서: `docs/internal/R1_COMPLETION_REPORT.md`
...
참고 문서: `docs/internal/R2_COMPLETION_REPORT.md`
...
참고 문서: `docs/internal/R3_PROGRESS_REPORT.md`
...
참고 문서: `docs/internal/R4_PROGRESS_REPORT.md`
...
참고 문서: `docs/internal/DEBUG_TOOL_PLAN.md`
...
- 상태/요청 사항은 `docs/internal/STATUS.md`에만 갱신
- 상세 증거/로그는 각 `*_REPORT.md`에 유지
- 중복 문서는 archive로 이동하고, 본문에서 링크만 유지
- `docs/internal/O1_PARALLEL_STATUS.md`는 요약/포인터 문서로 유지
